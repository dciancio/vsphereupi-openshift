...
if [ $? -ne 0 ]; then
  echo "WARNING:  HTTPD service is not running on this system.  The bootstrap.ign file has been generated but will need to manually be copied to the HTTPD serve
r." >&2
  exit 1
else
